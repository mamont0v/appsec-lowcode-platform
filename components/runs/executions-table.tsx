            ...
            <Table className='h-full'>
                <TableHeader className='bg-muted'>
                    <TableRow>
                        ...
                        <TableHead>Кредитов потрачено</TableHead>
                        <TableHead className='text-right text-xs text-muted-foreground'>Начало в (по убыванию)</TableHead>
                    </TableRow>
                </TableHeader>
                    ...
                    {query.data.map((execution) => {
                        ...
                        return (
                            <TableRow
                                ...
                                onClick={() => {
                                    router.push(`/app/workflow/runs/${execution.workflowId}/${execution.id}`)
                                }}>
                                <TableCell>
                                    <div className="flex flex-col">
                                        <span className="font-semibold">{execution.id}
                                        </span>
                                        <div className="text-muted-foreground text-xs">
                                            <span className="">Режим запуска</span>
